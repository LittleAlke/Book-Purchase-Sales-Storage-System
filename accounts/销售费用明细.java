...
public class 销售费用明细 extends JPanel implements ActionListener {
	  ...
	  public  销售费用明细() {
        ...
        JLabel title =new JLabel("销售费用明细");
        title.setFont(f2);
	...
	public void actionPerformed(ActionEvent e) {					
		if (e.getSource()==查询) {
			...
			String sql2=" SELECT*  FROM sell where Year(销售日期)="+nian+"&&Month(销售日期) ="+yue+"  ";
