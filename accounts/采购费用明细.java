...
public class 采购费用明细 extends JPanel implements ActionListener {
	  ...
	  public  采购费用明细() {
        ...
        JLabel title =new JLabel("采购费用明细");
        title.setFont(f2);
	...
	public void actionPerformed(ActionEvent e) {					
		if (e.getSource()==查询) {
			...
			String sql2=" SELECT*  FROM buy where Year(采购日期)="+nian+"&&Month(采购日期) ="+yue+"  ";
