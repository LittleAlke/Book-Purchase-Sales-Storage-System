...
public class 历史销售信息 extends JPanel implements ActionListener {
	  ...
	  public  历史销售信息() {
		...
		String sql1="select * from salesdetail";
        ...
        JLabel title =new JLabel("历史销售信息");
        title.setFont(f2);
	...
	public void actionPerformed(ActionEvent e) {					
		if (e.getSource()==查询) {
			...
			String sql2=" SELECT*  FROM salesdetail where Year(销售日期)="+nian+"&&Month(销售日期) ="+yue+"  ";
